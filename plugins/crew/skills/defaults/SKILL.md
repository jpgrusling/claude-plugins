...
- **Personas** — a skin for the six roles (foreman, surveyor, builder, inspector, diagnostician, scout). Offer the shipped presets (`cat "${CLAUDE_PLUGIN_ROOT}/reference/presets.json"`) or take custom names.
